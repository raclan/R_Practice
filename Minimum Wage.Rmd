...
animate(g, duration = 10, fps = 26, renderer = gifski_renderer())
anim_save("min_wage_map.gif")
```

```{r plot_map_2020, out.height = "70%", out.width = "70%", echo = TRUE, eval = FALSE}
...
ggplot(data = min_wage) + 
  ...
  labs(y = "State Minimum Wage in 2020 (dollars)") +
  theme_classic()
```